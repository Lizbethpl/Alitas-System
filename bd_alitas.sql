...
CREATE TABLE `sales` (
  ...
  `id_sales_product` int NOT NULL,
  PRIMARY KEY (`id_sale`,`id_sales_product`)
...
INSERT INTO `sales_product` VALUES (105,NULL,0,'',0,0);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shift` (
  `shift_s` double DEFAULT NULL,
  `id_sales_shift` int DEFAULT NULL
...
CREATE TABLE `ticketsave` (
  `sales_id_sale` int DEFAULT NULL,
...
INSERT INTO `users` VALUES (26,'Admin','Perez','Sanchez','7712386930','Mujer','2021-02-28','12345',1),(28,'lizbeth','perez','lopez','5778878','Mujer','2021-02-28','hola',1),(29,'Jovani','Reyes','Benitez','7732236315','Hombre','2021-03-01','password',2);
...
-- Dump completed on 2021-03-05 21:10:07
